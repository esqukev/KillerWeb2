  ...
  return (
    <div className="min-h-screen w-full bg-black text-white font-mono relative overflow-hidden">
      ...
      <div className="absolute inset-0 z-0 bg-black">
        ...
        {/* Twinkling Stars/Lightning */}
        <div className="absolute top-1/4 left-1/2 w-1 h-1 bg-white/30 rounded-full animate-pulse"></div>
        <div className="absolute bottom-1/4 right-1/2 w-1 h-1 bg-white/25 rounded-full animate-pulse" style={{animationDelay: '0.5s'}}></div>
        <div className="absolute top-1/2 left-1/4 w-1 h-1 bg-white/35 rounded-full animate-pulse" style={{animationDelay: '1s'}}></div>
        <div className="absolute top-1/3 right-1/3 w-0.5 h-0.5 bg-white/40 rounded-full animate-pulse" style={{animationDelay: '1.5s'}}></div>
        <div className="absolute bottom-1/3 left-1/3 w-0.5 h-0.5 bg-white/20 rounded-full animate-pulse" style={{animationDelay: '2s'}}></div>
        <div className="absolute top-2/3 right-1/6 w-1 h-1 bg-white/30 rounded-full animate-pulse" style={{animationDelay: '2.5s'}}></div>
        <div className="absolute bottom-2/3 left-2/3 w-0.5 h-0.5 bg-white/25 rounded-full animate-pulse" style={{animationDelay: '3s'}}></div>
        <div className="absolute top-1/6 right-2/3 w-1 h-1 bg-white/35 rounded-full animate-pulse" style={{animationDelay: '3.5s'}}></div>
        <div className="absolute bottom-1/6 left-1/6 w-0.5 h-0.5 bg-white/20 rounded-full animate-pulse" style={{animationDelay: '4s'}}></div>
        <div className="absolute top-3/4 right-1/4 w-1 h-1 bg-white/30 rounded-full animate-pulse" style={{animationDelay: '4.5s'}}></div>
        <div className="absolute top-1/8 left-1/8 w-0.5 h-0.5 bg-white/45 rounded-full animate-pulse" style={{animationDelay: '5s'}}></div>
        <div className="absolute bottom-1/8 right-1/8 w-1 h-1 bg-white/15 rounded-full animate-pulse" style={{animationDelay: '5.5s'}}></div>
        <div className="absolute top-5/6 left-1/3 w-0.5 h-0.5 bg-white/35 rounded-full animate-pulse" style={{animationDelay: '6s'}}></div>
        <div className="absolute bottom-5/6 right-1/3 w-1 h-1 bg-white/25 rounded-full animate-pulse" style={{animationDelay: '6.5s'}}></div>
      ...
      {/* Footer */}
      <footer className="absolute bottom-[8px] left-4 md:left-8 right-4 md:right-8 z-20" style={{top: 'calc(100vh - 100px)'}}>
